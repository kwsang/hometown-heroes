# Project: The Hometown Success Engine - TeamUSA Hackathon

## Requirements

One of the main priorities is to build the next generation of fan engagement tools.

Transform Team USA and publicly available data into interactive dashboards, web apps, or AI agents that showcase the collective power of Team USA.
...
General number of Olympians/Paralympians from hometown regions and public geographical/climate data.

We must rely exclusively on publicly available Team USA datasets. Participants are explicitly instructed to use the following publicly accessible sources for their projects:
...
You must not use any olympic terminology and should use generic terms throughout your project.
